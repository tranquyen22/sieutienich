...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 2,
    name: "Áo Sơ mi Nam Công sở Phong cách Hàn Quốc",
    category: "fashion",
    price: 350000,
  ...
  {
    id: 3,
    name: "Set Lẩu Thái Hải Sản & Trà Trái Cây 4 Người",
    category: "food",
    price: 490000,
  ...
  {
    id: 4,
    name: "Liệu trình Spa Chăm sóc Da mặt & Thải độc Chuyên sâu",
    category: "spa",
    price: 650000,
  ...
  {
    id: 5,
    name: "Combo Nhu yếu phẩm Gia đình Hữu cơ (Gạo, Dầu ăn, Gia vị)",
    category: "groceries",
    price: 280000,
