...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 15,
    name: "Món Ăn Đặc Sản Gà Đông Tảo Chuẩn Vẩy Rồng Khoái Châu (TQ Food)",
    category: "food",
    price: 850000,
    img: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=500&q=80",
    description: "Nhà hàng chuyên chế biến Gà Đông Tảo chân khủng 7 món đậm đà hương vị truyền thống Khoái Châu.",
    isTQStore: true,
    isLicensed: true,
    rating: 5.0,
    reviewCount: 156,
  ...
  {
    id: 16,
    name: "Homestay Sinh Thái Sông Hồng Khoái Châu (Đã Xác Minh GPKD)",
    category: "lodging",
    price: 650000,
    img: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=500&q=80",
    description: "Khu lưu trú nghỉ dưỡng ven sông Hồng không gian xanh. Đầy đủ giấy phép kinh doanh PCCC.",
    phone: "0982.333.444",
    isLicensed: true,
    licenseNo: "GPKD: 0900123456",
    contactName: "Anh Hoàng (Chủ Homestay Khoái Châu)",
    rating: 4.9,
    reviewCount: 54,
    province: "Hưng Yên",
    district: "Huyện Khoái Châu",
    distanceKm: 3.2,
    locationName: "Xã Bình Minh, Huyện Khoái Châu, Hưng Yên"
  },
  {
    id: 17,
    name: "Dịch Vụ Xe Ba Gác & Xe Tải Chở Nông Sản Khoái Châu Hưng Yên",
    category: "transport",
    price: 250000,
    img: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=500&q=80",
    description: "Nhà xe Tuấn Khoái Châu nhận chở nông sản, vật tư xây dựng nội huyện Khoái Châu và đi các tỉnh lân cận.",
    phone: "0915.888.999",
    contactName: "Anh Tuấn (Nhà xe Khoái Châu)",
    isLicensed: true,
    rating: 4.8,
    reviewCount: 39,
    province: "Hưng Yên",
  ...
  {
    id: 18,
    name: "Spa Đông Y Chăm Sóc Da & Gội Đầu Dưỡng Sinh Khoái Châu (TQ Spa)",
    category: "spa",
    price: 250000,
    img: "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=500&q=80",
    description: "Gội đầu thảo dược thiên nhiên, triệt lông công nghệ cao và chăm sóc da mặt chuyên sâu.",
    isTQStore: true,
    isLicensed: true,
    rating: 4.9,
    reviewCount: 88,
  ...
  {
    id: 19,
    name: "Tuyển Dụng Quản Lý Kho Bãi & Vận Chuyển Nông Sản (Lương 12-15tr)",
    category: "jobs",
    price: 13500000,
    img: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=500&q=80",
    description: "Tuyển vị trí quản lý điều phối kho vận tại Dân Tiến Khoái Châu. Thưởng KPI hấp dẫn.",
    isLicensed: true,
    rating: 5.0,
    reviewCount: 29,
    province: "Hưng Yên",
    district: "Huyện Khoái Châu",
    distanceKm: 4.0,
    locationName: "Xã Dân Tiến, Huyện Khoái Châu, Hưng Yên"
  },
  {
    id: 20,
    name: "Dịch Vụ Vệ Sinh Máy Lạnh & Sửa Chữa Điện Nước Tận Nhà Khoái Châu",
    category: "home_services",
    price: 180000,
    img: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=500&q=80",
    description: "Thợ điện nước lành nghề phục vụ tận nhà khu vực Huyện Khoái Châu. Bảo hành 30 ngày.",
    isLicensed: true,
    rating: 4.8,
    reviewCount: 65,
    province: "Hưng Yên",
    district: "Huyện Khoái Châu",
    distanceKm: 2.2,
    locationName: "Xã Tân Dân, Huyện Khoái Châu, Hưng Yên"
  }
];
