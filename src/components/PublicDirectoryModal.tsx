...
export const PublicDirectoryModal: React.FC<PublicDirectoryModalProps> = ({ isOpen, onClose }) => {
  ...
  const [categories, setCategories] = useState<DirectoryCategory[]>([
    ...
    { id: 'van_tai', name: '🚗 Vận Tải & Taxi Nội Khu', description: 'Xe ôm, taxi gia đình, xe tải chở hàng' },
    { id: 'luu_tru', name: '🏨 Lưu Trú & Nhà Nghỉ', description: 'Khách sạn, nhà nghỉ, homestay' },
    { id: 'sua_chua', name: '🔧 Sửa Chữa Điện Nước & Đồ Điện', description: 'Thợ sửa điện nước, máy lạnh, xe máy' },
    { id: 'tien_ich_gia_dinh', name: '🧺 Tiện Ích Gia Đình & Giặt Là', description: 'Giặt khô, dọn dẹp nhà cửa, bơm ga' },
    { id: 'cuu_ho', name: '🚑 Cứu Hộ 24/7 & Y Tế', description: 'Xe cứu hộ giao thông, trung tâm y tế' },
  ]);
  ...
  const [entries, setEntries] = useState<DirectoryEntry[]>([
    {
      id: 'DIR-001',
      title: 'Thợ Sửa Điện Nước & Máy Lạnh Hùng Cường',
      category_id: 'sua_chua',
      phone: '0912345678',
      address: 'Số 18 Thị trấn Khoái Châu, Hưng Yên',
      province: 'Hưng Yên',
      district: 'Khoái Châu',
      ward: 'Thị trấn Khoái Châu',
      distance_km: 1.2,
      is_verified: true, // Đã xác minh
      verified_by: 'Admin Tổng (Trần Văn Quyền)',
    ...
    {
      id: 'DIR-002',
      title: 'Taxi Gia Đình Khoái Châu 24/7 (Đón Tận Nơi)',
      category_id: 'van_tai',
      phone: '0987654321',
      ...
      distance_km: 3.5,
      is_verified: true,
      verified_by: 'Nhân viên Nhập liệu Danh bạ',
    ...
    {
      id: 'DIR-003',
      title: 'Nhà Nghỉ & Homestay Sông Hồng',
      category_id: 'luu_tru',
      phone: '0933445566',
      ...
      ward: 'Thị trấn Khoái Châu',
      distance_km: 4.8,
      is_verified: false, // MẶC ĐỊNH LÀ CHƯA XÁC MINH
      report_wrong_number_count: 1,
      created_at: '2026-08-20T00:00:00.000Z',
    },
    {
      id: 'DIR-004',
      title: 'Giặt Sấy Lấy Ngay & Dọn Nhà Sạch 247',
      category_id: 'tien_ich_gia_dinh',
      phone: '0977889900',
      address: 'Ngõ 102 Trần Thái Tông, Cầu Giấy, Hà Nội',
      province: 'Hà Nội',
      district: 'Cầu Giấy',
      ward: 'Dịch Vọng',
      distance_km: 0.8,
  ...
  const [newCategory, setNewCategory] = useState('van_tai');
